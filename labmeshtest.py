...
authors: Joost Dorscheidt, Joost Meulenbeld, Dawud Hage,  and Dennis van der Hoff 
...
class Colorbins(object):
    ...
    def plot_meshgrid(self, xlabel='a', ylabel='b', axis=(0,1)):
        ...
        ax.set_xlabel(xlabel, color='black', fontsize=20, labelpad=5)
        ax.set_ylabel(ylabel, color='black', fontsize=20, labelpad=0)
        plot.grid()
        plot.show()
